...
var WuiTokenListItem = class WuiTokenListItem2 extends LitElement {
  ...
  render() {
    ...
    const value = this.amount && this.price ? (_a5 = NumberUtil.multiply(this.price, this.amount)) == null ? void 0 : _a5.toFixed(3) : null;
    return html`
      <wui-flex alignItems="center">
        ${this.visualTemplate()}
        <wui-flex flexDirection="column" gap="3xs">
...
var WuiProfileButtonV2 = class WuiProfileButtonV22 extends LitElement {
  ...
  handleClick(event) {
    ...
    if (event.target instanceof HTMLElement && event.target.id === "copy-address") {
      (_a5 = this.onCopyClick) == null ? void 0 : _a5.call(this, event);
      return;
    }
...
var WuiInputAmount = class WuiInputAmount2 extends LitElement {
  ...
  dispatchInputChangeEvent(e) {
    ...
    if (inputChar && ((_a5 = this.inputElementRef) == null ? void 0 : _a5.value)) {
      if (inputChar === ",") {
...
var WuiListAccount = class WuiListAccount2 extends LitElement {
  ...
  connectedCallback() {
    var _a5;
    super.connectedCallback();
    BlockchainApiController.getBalance(this.accountAddress, (_a5 = this.caipNetwork) == null ? void 0 : _a5.id).then((response) => {
  ...
  getLabel() {
    var _a5;
    let label = (_a5 = this.labels) == null ? void 0 : _a5.get(this.accountAddress);
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EAIBTAEN.js.map
