        ...
        <div className={`${popup ? "flex items-center justify-center w-full h-[100vh] bg-[#0b1023e6] fixed top-0 left-0 z-[1500]" : "hidden"}`}>
            <div className="relative bg-popup bg-no-repeat bg-[length:100%_100%] w-full max-w-[500px] h-auto pt-20 sm:pt-28 sm:pt-32  mt-10 scale-[.7] xl:scale-[1]">
                ...
                <ul className="list-popup w-[70%] mx-auto text-white text-[12px]">
                    <li><span>1.</span> <span className="text-sm">✅</span> Exclusive access to influence the future of Captain Hook</li>
                    <li><span>2.</span> <span className="text-lg">💰</span> Raffle for $5,000 + 5 Ledger wallets! (For contributions over $100)</li>
                    <li><span>3.</span> <span className="text-lg">📈</span> 5% More Tokens!</li>
                ...
                <p className="w-[85%] mx-auto open-sans-Medium text-white text-[12px] mt-2">Don’t miss this opportunity! Join the VIP Club now and be part of the Captain Hook journey!</p>
