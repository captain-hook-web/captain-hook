...
function PRLogoSlider({ gears, imagesSlider }) {
    ...
    return (
        <div className="section-rail relative bg-stick-slider bg-[length:100%_100%] bg-no-repeat pt-[40px] pb-[40px]">
