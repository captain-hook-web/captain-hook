...
function HeroSection() {
  ...
  const initVoidSigner = useCallback(async () => {
    try {
      ...
      let totalSoldToken = 13395800;
      let totalTokenToSell = 0;
      let currentStageSoldToken = 4570170;
      ...
      setProgressBar(
        (Number(currentStageSoldToken) / Number(currentStageTokenSell - 3080000)) * 100
      );
    } catch (e) {
          ...
          <Grid container>
            ...
            >
              ...
              >
                ...
                >
                  {/* <CountDownTimer time={1739490793} /> */}
                </Stack>
                {<Box
                  mt={2}
                  sx={{
